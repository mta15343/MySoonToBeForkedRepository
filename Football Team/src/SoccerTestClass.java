...
public class SoccerTestClass {
	...
	public static void main(String[] args) {
		// *************************************************************
		// Team 1 (Germany)
		Trainer t1 = new Trainer("Juergen Klinsmann", 340, 9);
		Keeper k1 = new Keeper("J. Lehmann", 36, 8, 1, 90, 7);
		Player[] p1 = new Player[10];
		p1[0] = new Player("P. Lahm", 23, 9, 50, 9);
		p1[1] = new Player("C. Metzelder", 25, 8, 20, 7);
		p1[2] = new Player("P. Mertesacker", 22, 9, 20, 8);
		p1[3] = new Player("M. Ballack", 29, 7, 50, 8);
		p1[4] = new Player("T. Borowski", 26, 9, 80, 9);
		p1[5] = new Player("D. Odonkor", 22, 7, 50, 8);
		p1[6] = new Player("B. Schweinsteiger", 22, 2, 30, 2);
		p1[7] = new Player("L. Podolski", 21, 7, 80, 9);
		p1[8] = new Player("M. Klose", 28, 10, 90, 7);
		p1[9] = new Player("O. Neuville", 33, 8, 80, 7);
		// *************************************************************
